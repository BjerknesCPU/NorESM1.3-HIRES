...
# 2086 "ncdio_pio.F90.in"
  end subroutine scam_field_offsets

  !------------------------------------------------------------------------

# 2090 "ncdio_pio.F90.in"
